...
export const DeployAppliation = async (req, res) => {
    try {
        ...
        const { status, deploymentUrl, hostname, providerResourceId, providerMetadata } = result;
...
export const get_all_deployment_instaces = async (req, res) => {
    try {
...
//# sourceMappingURL=Deployemnt.controller.js.map